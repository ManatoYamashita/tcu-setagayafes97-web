 ...
 * 企画詳細ページのエラーページ
 *
 * 一覧のエラーページ（`src/app/events/error.tsx`）と同じ `PageSheetLayout` を使う。
 * 以前は濃紫グラデーション（primary-600 → primary-400）の上に text-gray-900 を
 * 直置きしており、本文が 3.4〜3.6:1 しかなかった（AA は 4.5:1。同じ構造の
 * not-found.tsx で実測）。詳細ページ本体が白いシートへ移った後も、
 * この2画面だけが暗色テーマのまま取り残されていた（#149）。
 */
