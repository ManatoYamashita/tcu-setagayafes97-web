    ...
    <div className="container mx-auto px-4 py-12">
      <div className="grid gap-8 lg:grid-cols-[2fr_1fr]">
        ...
        <div className="overflow-hidden rounded-lg border border-gray-200/20 bg-white/10 shadow-sm">
          ...
          <svg viewBox="0 0 1000 750" className="h-full w-full" xmlns="http://www.w3.org/2000/svg">
            {/* 背景 */}
            ...
            <g opacity="0.1">
              {[...Array(20)].map((_, i) => (
                <g key={i}>
                  <line x1={i * 50} y1="0" x2={i * 50} y2="750" stroke="#94a3b8" strokeWidth="1" />
                  <line
                    x1="0"
                    y1={i * 37.5}
                    x2="1000"
            ...
            {selectedBuilding ? (
              <div className="space-y-4">
                ...
                <Link
                  ...
                  className="inline-flex w-full items-center justify-center rounded-lg bg-white px-4 py-3 font-semibold text-primary transition-all hover:bg-white/90 hover:shadow-lg"
                >
                  この建物の企画を見る
                </Link>
              </div>
