      ...
      <div className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-5xl space-y-8">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {/* 駐車場 */}
            <section className="rounded-lg border border-gray-200/20 bg-white/10 p-6 shadow-sm">
              <div className="mb-4 flex items-center gap-3">
              ...
              <div className="space-y-3">
                <div>
                  <p className="text-sm font-semibold text-gray-900/60">利用可否</p>
                ...
                {accessConfig.bicycle.parkingAvailable && (
                  <>
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <p className="text-sm font-semibold text-gray-900/60">収容台数</p>
                        <p className="font-bold text-gray-900">
                          約 {accessConfig.bicycle.capacity}台
                        </p>
                      </div>
                      <div>
                        <p className="text-sm font-semibold text-gray-900/60">場所</p>
                        <p className="font-bold text-gray-900">{accessConfig.bicycle.location}</p>
                      </div>
                    </div>
                    <div className="rounded-lg bg-white/10 p-4">
                      <p className="text-sm text-gray-900/90">{accessConfig.bicycle.note}</p>
                    </div>
                  </>
                )}
              </div>
