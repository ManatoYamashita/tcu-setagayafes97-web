    ...
    >
      ...
      <div className="mx-auto max-w-4xl space-y-12">
        ...
        <section className="rounded-lg border border-gray-200/20 bg-gray-50 p-6 shadow-sm md:p-8">
          ...
          {/* 組織構成 */}
          <div>
            <h3 className="mb-4 text-lg font-bold text-gray-900">{t("committee.organization")}</h3>
        ...
        {/* SNSリンク */}
        <section className="rounded-lg border border-gray-200/20 bg-gray-50 p-6 shadow-sm md:p-8">
          <h2 className="mb-6 text-center text-2xl font-bold text-gray-900">{t("social.title")}</h2>
