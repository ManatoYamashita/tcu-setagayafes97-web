        ...
        <div className="mx-auto max-w-4xl space-y-12">
          ...
          <section className="rounded-lg border border-white/20 bg-white/10 p-6 shadow-sm md:p-8">
            <div className="mb-6 flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold text-white">{t("sections.admission")}</h2>
            </div>
            <div className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  <p className="text-sm font-semibold text-white/60">{t("labels.admissionFee")}</p>
                  <p className="text-xl font-bold text-primary-light">
                    {guideConfig.admission.fee}
                  </p>
                </div>
                <div>
                  <p className="text-sm font-semibold text-white/60">{t("labels.openingHours")}</p>
              ...
              <ul className="mt-4 space-y-2">
                {guideConfig.admission.notes.map((note, index) => (
                  <li key={index} className="flex items-start gap-2 text-white/90">
                    <span className="mt-1.5 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-primary-light"></span>
                    <span>{note}</span>
                  </li>
                ))}
              </ul>
          ...
          <section className="rounded-lg border border-white/20 bg-white/10 p-6 shadow-sm md:p-8">
            <div className="mb-6 flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold text-white">{t("sections.precautions")}</h2>
            </div>
            <div className="grid gap-4 md:grid-cols-2">
          ...
          <section className="rounded-lg border border-white/20 bg-white/10 p-6 shadow-sm md:p-8">
            <div className="mb-6 flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold text-white">{t("sections.accessibility")}</h2>
            </div>
            <div className="space-y-4">
              <div className="grid gap-4 md:grid-cols-3">
                <div className="rounded-lg bg-pink-500/10 p-4 text-center">
              ...
              <div>
                <p className="mb-2 font-semibold text-white">{t("labels.elevatorsIn")}:</p>
                <p className="text-white/90">{guideConfig.accessibility.elevators.join("、")}</p>
              </div>
              <ul className="space-y-2">
                {guideConfig.accessibility.notes.map((note, index) => (
                  <li key={index} className="flex items-start gap-2 text-white/90">
                    <span className="mt-1.5 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-pink-400"></span>
                    <span>{note}</span>
                  </li>
                ))}
              </ul>
          ...
          <section className="rounded-lg border border-white/20 bg-white/10 p-6 shadow-sm md:p-8">
            <div className="mb-6 flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold text-white">{t("sections.weather")}</h2>
            </div>
          ...
          <section className="rounded-lg border border-white/20 bg-white/10 p-6 shadow-sm md:p-8">
            <div className="mb-6 flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold text-white">{t("sections.lostFound")}</h2>
            </div>
            <div className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                <div>
              ...
              <ul className="space-y-2">
                {guideConfig.lostAndFound.notes.map((note, index) => (
                  <li key={index} className="flex items-start gap-2 text-white/90">
                    <span className="mt-1.5 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-green-400"></span>
                    <span>{note}</span>
                  </li>
                ))}
              </ul>
          ...
          <section className="rounded-lg border border-white/20 bg-white/10 p-6 shadow-sm md:p-8">
            <div className="mb-6 flex items-center gap-3">
              <Baby className="h-6 w-6 text-purple-300" />
              <h2 className="text-2xl font-bold text-white">{t("sections.families")}</h2>
            </div>
            <div className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
              ...
              <ul className="space-y-2">
                {guideConfig.forFamilies.notes.map((note, index) => (
                  <li key={index} className="flex items-start gap-2 text-white/90">
                    <span className="mt-1.5 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-purple-300"></span>
                    <span>{note}</span>
                  </li>
                ))}
              </ul>
          ...
          {/* 緊急時の対応 */}
          <section className="rounded-lg border border-red-400/30 bg-red-500/10 p-6 shadow-sm md:p-8">
            <div className="mb-6 flex items-center gap-3">
            ...
            <div className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  <p className="text-sm font-semibold text-white/80">{t("labels.medicalRoom")}</p>
              ...
              <ul className="space-y-2">
                {guideConfig.emergency.notes.map((note, index) => (
                  <li key={index} className="flex items-start gap-2 text-white/90">
                    <span className="mt-1.5 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-red-400"></span>
                    <span>{note}</span>
                  </li>
                ))}
              </ul>
