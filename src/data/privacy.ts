...
export const privacyPolicyConfig = {
  ...
  // 第三者提供
  //
  // `externalServices` は「原則として提供しない」の例外を、実際に送信しているものとして
  // 具体的に書く欄です。**送信先を増やしたら必ずここへ足してください。**
  // 企画検索の第4段は来場者が入力した文字列を米国の TypeSafe, Inc. へ送信しており、
  // ゼロデータ保持（ZDR）はエンタープライズ契約でのみ提供されるため、送信内容は保持されます。
  thirdParty: {
