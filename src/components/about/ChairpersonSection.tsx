...
export function ChairpersonSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-gray-50 py-24 lg:py-32">
      {/* ── 装飾三角形 ×6（lg以上のみ） ── */}
      <div
        className="hidden lg:block absolute top-16 right-[5%] w-20 h-20 bg-primary-200 rotate-[15deg]"
        style={{ clipPath: "polygon(50% 0%, 0% 100%, 100% 100%)" }}
        aria-hidden="true"
      />
      <div
        className="hidden lg:block absolute top-[12%] left-[8%] w-8 h-8 bg-primary-100 -rotate-[10deg]"
        style={{ clipPath: "polygon(50% 0%, 0% 100%, 100% 100%)" }}
        aria-hidden="true"
      />
      <div
        className="hidden lg:block absolute top-[42%] right-[30%] w-12 h-12 bg-primary-200/60 rotate-[40deg]"
        style={{ clipPath: "polygon(50% 0%, 0% 100%, 100% 100%)" }}
        aria-hidden="true"
      />
      <div
        className="hidden lg:block absolute top-[58%] left-[4%] w-6 h-6 bg-primary-200 rotate-[25deg]"
        style={{ clipPath: "polygon(50% 0%, 0% 100%, 100% 100%)" }}
        aria-hidden="true"
      />
      <div
        className="hidden lg:block absolute bottom-[18%] right-[8%] w-14 h-14 bg-primary-100 -rotate-[20deg]"
        style={{ clipPath: "polygon(50% 0%, 0% 100%, 100% 100%)" }}
        aria-hidden="true"
      />
      <div
        className="hidden lg:block absolute bottom-[8%] left-[20%] w-10 h-10 bg-primary-200/40 rotate-[55deg]"
        style={{ clipPath: "polygon(50% 0%, 0% 100%, 100% 100%)" }}
        aria-hidden="true"
      />
      ...
      <div className="mx-auto max-w-6xl px-8 sm:px-12 lg:px-16">
        ...
        <div className="flex flex-col gap-8 lg:grid lg:grid-cols-12 lg:gap-x-6 lg:gap-y-0">
          {/* ── ラベル (MESSAGE) ── col 8-10, row 1 */}
          <div className="lg:col-start-8 lg:col-end-11 lg:row-start-1">
          ...
          {/* ── 見出し ── col 8-12, row 2 */}
          <div className="lg:col-start-8 lg:col-end-13 lg:row-start-2 lg:mt-2">
            <h2 className="font-heading text-3xl font-bold leading-tight text-gray-900 whitespace-pre-line lg:text-5xl">
              {heading}
            </h2>
          </div>

          {/* ── briefDescription ── col 7-10, row 4 */}
          <div className="lg:col-start-7 lg:col-end-11 lg:row-start-4">
          ...
          <div className="lg:col-start-2 lg:col-end-7 lg:row-start-2 lg:row-end-5 lg:pt-8">
