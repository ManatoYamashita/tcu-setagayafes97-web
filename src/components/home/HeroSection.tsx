    ...
    <section className="w-full min-h-[calc(100vh-5rem)] pt-20 relative bg-white overflow-hidden flex items-center justify-center">
        ...
        <div className="max-w-7xl mx-auto w-full px-6 lg:px-8 pointer-events-auto">
          ...
          <div className="flex items-center gap-4 mt-6">
            <a
              href="/events"
              aria-label="企画一覧を見る"
              className="w-16 h-16 rounded-full bg-white border border-gray-200 flex items-center justify-center hover:border-primary transition-colors"
            >
      ...
      <div className="absolute right-0 sm:right-4 md:right-6 lg:right-8 xl:right-10 2xl:right-12 top-1/2 -translate-y-1/2 z-10">
        ...
        <div className="relative">
          <div className="relative w-[95vw] sm:w-[85vw] md:w-[82vw] lg:w-[82vw] xl:w-[82vw] h-[65vh] sm:h-[72vh] md:h-[78vh] lg:h-[80vh] xl:h-[82vh] rounded-2xl overflow-hidden">
            <Image
            ...
            {/* 左上通知ラベル（z-30、内側維持） */}
            <div className="absolute top-6 left-6 sm:top-8 sm:left-8 bg-accent-yellow px-6 py-3 sm:px-8 sm:py-4 rounded max-w-[85%] sm:max-w-[60%] z-30">
          ...
          <div className="absolute -top-8 -right-8 sm:-top-10 sm:-right-10 md:-top-12 md:-right-12 lg:-top-14 lg:-right-14 xl:-top-14 xl:-right-14 2xl:-top-16 2xl:-right-16 w-32 sm:w-40 md:w-48 lg:w-56 xl:w-60 2xl:w-64 aspect-square rounded-full overflow-hidden z-30">
            <Image
              src="/images/placeholder/p.jpeg"
