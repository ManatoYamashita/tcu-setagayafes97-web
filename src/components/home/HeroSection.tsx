...
export function HeroSection() {
  return (
    <section className="relative w-full">
      {/* ファーストビュー領域（100svh） */}
      <div className="relative h-[100svh] bg-white overflow-hidden flex items-center justify-center">
        ...
        {/* 画像エリア（absolute、右寄り、bottom-[1rem]配置、z-10） */}
        <div className="absolute right-0 sm:right-4 md:right-6 lg:right-8 xl:right-10 2xl:right-12 bottom-[1rem] z-10">
          {/* 新規ラッパー追加 */}
      ...
      {/* 追加領域（Scroll/SNS、100svh以降、緑色背景） */}
      <div className="relative bg-accent-green py-12 lg:py-16">
